import { Globe, ShieldCheck, Copy, ExternalLink } from "lucide-react";
      ...
      <div className="flex flex-col gap-4 sm:gap-5 flex-1">
        ...
        {isRunning ? (
            ...
            <div className="relative group/url">
              ...
              <div className="relative bg-black/60 backdrop-blur-xl border border-(--glass-border) rounded-lg sm:rounded-xl p-3 sm:p-4 flex justify-between items-center transition-all duration-300">
                <div className="flex-1 overflow-hidden pr-3 sm:pr-4">
                  ...
                  <p className="font-mono text-[11px] sm:text-[13px] text-white truncate opacity-90 group-hover/url:opacity-100 transition-opacity">
                    https://proxlyte.run/tunnel-xj9k
                  </p>
                </div>
                <div className="flex items-center gap-1 sm:gap-1.5">
                  <button className="text-white/40 hover:text-white hover:bg-white/10 p-1.5 sm:p-2 rounded-lg transition-all duration-300">
          ...
          <div className="flex-1 mt-auto flex flex-col items-center justify-center p-8 border border-dashed border-(--glass-border) rounded-3xl bg-black/20">
            ...
            <p className="text-[11px] text-(--text-extra-dim) text-center max-w-[200px]">
